...
SNIPEIT_SH_URL= "https://raw.githubusercontent.com/jozour/jozour-it/master/jozourit.sh"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "centos7" do |centos7|
    ...
    centos7.vm.provision :shell, :inline => "chmod 755 jozourit.sh"
  end
  ...
  config.vm.define "centos6" do |centos6|
    ...
    centos6.vm.provision :shell, :inline => "chmod 755 jozourit.sh"
  end
  ...
  config.vm.define "jessie" do |jessie|
    ...
    jessie.vm.provision :shell, :inline => "chmod 755 jozourit.sh"
  end
  ...
  config.vm.define "stretch" do |stretch|
    ...
    stretch.vm.provision :shell, :inline => "chmod 755 jozourit.sh"
  end
  ...
  config.vm.define "fedora27" do |fedora27|
    ...
    fedora27.vm.provision :shell, :inline => "chmod 755 jozourit.sh"
  end
    ...
    fedora26.vm.provision :shell, :inline => "chmod 755 jozourit.sh"
  end
