...
if (version_compare(PHP_VERSION, $required_php_min, '<')) {
    echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ERROR !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n";
    echo "This version of PHP (".PHP_VERSION.") is not compatible with Jozour-IT.\n";
    echo "Jozour-IT requires PHP version ".$required_php_min." or greater. Please upgrade \n";
...
echo "--------------------------------------------------------\n\n";
$backup = shell_exec('php artisan jozourit:backup');
echo '-- '.$backup."\n\n";
...
if ((strpos('git version', $git_version)) === false) {
    ...
    echo "Please note that this script will not download the latest Jozour-IT \n";
