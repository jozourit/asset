 ...
 * @param  {JSON} settings Insulated `window.jozourit.settings` object.
...
}(jQuery, window.jozourit.settings));
...
$(document).ready(function () {
    ...
    */
    ...
    // So a URL such as, http://jozour-it.local/hardware/2/#my_tab will
