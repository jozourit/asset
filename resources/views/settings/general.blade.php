                   ...
                   <div class="form-group {{ $errors->has('default_eula_text') ? 'error' : '' }}">
                    ...
                    <div class="form-group {{ $errors->has('login_note') ? 'error' : '' }}">
                       ...
                       <div class="form-group {{ $errors->has('show_in_model_list') ? 'error' : '' }}">
                           ...
                           <div class="col-md-9">
                               {{ Form::checkbox('show_in_model_list[]', 'image', old('show_in_model_list', $jozourSettings->modellistCheckedValue('image')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.image') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'category', old('show_in_model_list', $jozourSettings->modellistCheckedValue('category')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.category') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'manufacturer', old('show_in_model_list', $jozourSettings->modellistCheckedValue('manufacturer')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }}  {{ trans('general.manufacturer') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'model_number', old('show_in_model_list', $jozourSettings->modellistCheckedValue('model_number')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.model_no') }}<br>
                           </div>
                       </div>
