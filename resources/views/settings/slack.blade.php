                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12" style="border-top: 0px;">
                        ...
                        <div class="form-group required {{ $errors->has('slack_botname') ? 'error' : '' }}">
                            ...
                            <div class="col-md-10">
                                @if (config('app.lock_passwords')===true)
                                    {{ Form::text('slack_botname', old('slack_botname', $setting->slack_botname), array('class' => 'form-control','disabled'=>'disabled','placeholder' => 'Jozour-Bot')) }}
                                    <p class="text-warning"><i class="fas fa-lock"></i> {{ trans('general.feature_disabled') }}</p>

                                @else
                                    {{ Form::text('slack_botname', old('slack_botname', $setting->slack_botname), array('class' => 'form-control','placeholder' => 'Jozour-Bot')) }}
                                @endif
