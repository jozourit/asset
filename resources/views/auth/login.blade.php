                    ...
                    <div class="box login-box">
                        ...
                        <div class="login-box-body">
                            <div class="row">
                                ...
                                @if ($jozourSettings->login_note)
                                    <div class="col-md-12">
                                        <div class="alert alert-info">
                                            {!!  Parsedown::instance()->text(e($jozourSettings->login_note))  !!}
                                        </div>
                                    </div>
                                @endif
                            ...
                            @if (!config('app.require_saml') && $jozourSettings->saml_enabled)
                            <div class="row ">
                        ...
                        <div class="text-right col-md-12 col-sm-12 col-xs-12" style="padding-top: 10px;">
                            @if ($jozourSettings->custom_forgot_pass_url)
                                <a href="{{ $jozourSettings->custom_forgot_pass_url  }}" rel="noopener">{{ trans('auth/general.forgot_password')  }}</a>
