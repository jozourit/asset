                            ...
                            @if (($jozourSettings->show_images_in_email=='1' ) && ($jozourSettings::setupCompleted()))
                                ...
                                @if ($jozourSettings->brand == '3')
                                    @if ($jozourSettings->logo!='')
                                        <img class="navbar-brand-img logo" style="max-width: 50px;" src="{{ url('/') }}/uploads/{{ $jozourSettings->logo }}">
                                    @endif
                            ...
                            <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        <!-- Salutation -->
                                        <p style="{{ $style['paragraph'] }}">
                                            Regards,<br>{{ $jozourSettings->site_name }}
                                        </p>
                            ...
                            <table style="{{ $style['email-footer'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                        <p style="{{ $style['paragraph-sub'] }}">
                                            &copy; {{ date('Y') }}
                                            <a style="{{ $style['anchor'] }}" href="{{ url('/') }}" target="_blank">{{ $jozourSettings->site_name }}</a>.
                                            All rights reserved.
                                        </p>
