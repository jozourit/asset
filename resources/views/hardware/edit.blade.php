    ...
    $(document).ready(function() {
        ...
        $(add_button).click(function(e){ //on add input button click
            ...
            if (x < max_fields) {
                ...
                box_html += '<input type="text"  class="form-control" name="asset_tags[' + x + ']" value="{{ (($jozourSettings->auto_increment_prefix!='') && ($jozourSettings->auto_increment_assets=='1')) ? $jozourSettings->auto_increment_prefix : '' }}'+ auto_tag +'" data-validation="required">';
                box_html += '</div>';
