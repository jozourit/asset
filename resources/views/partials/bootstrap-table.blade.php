...
<script nonce="{{ csrf_token() }}">
    $(function () {
        ...
        $('.jozour-table').bootstrapTable('destroy').each(function () {
            ...
            pageSize: {{  (($jozourSettings->per_page!='') && ($jozourSettings->per_page > 0)) ? $jozourSettings->per_page : 20 }},
    ...
    function dateRowCheckStyle(value) {
        if ((value.days_to_next_audit) && (value.days_to_next_audit < {{ $jozourSettings->audit_warning_days ?: 0 }})) {
    ...
    $('.jozour-table').on('check.bs.table .btSelectItem', function (row, $element) {
    ...
    $('.jozour-table').on('uncheck.bs.table .btSelectItem', function (row, $element) {
        var tableId =  $(this).data('id-table');
        $( "#" + tableId + "_checkbox_" + $element.id).remove();
    });


    $('.jozour-table').on('check-all.bs.table', function (event, rowsAfter, rowsBefore) {
    ...
    $('.jozour-table').on('uncheck.bs.table', function () {
    ...
    $('.jozour-table').on('uncheck-all.bs.table', function (event, rowsAfter, rowsBefore) {
    ...
    function polymorphicItemFormatter(value) {
        ...
        if ((value) && (value.type)) {
            ...
            return '<nobr><a href="{{ url('/') }}/' + item_destination +'/' + value.id + '" data-tooltip="true" title="' + value.type + '"><i class="' + item_icon + ' text-{{ $jozourSettings->skin!='' ? $jozourSettings->skin : 'blue' }} "></i> ' + value.name + '</a></nobr>';
   ...
   function imageFormatter(value, row) {
        ...
        if (value) {
            ...
            return '<a href="' + value + '" data-toggle="lightbox" data-type="image"><img src="' + value + '" style="max-height: {{ $jozourSettings->thumbnail_max_h }}px; width: auto;" class="img-responsive" alt="' + altName + '"></a>';
        }
    }
    ...
    function fileUploadFormatter(value) {
        if ((value) && (value.url) && (value.inlineable)) {
            return '<a href="' + value.url + '" data-toggle="lightbox" data-type="image"><img src="' + value.url + '" style="max-height: {{ $jozourSettings->thumbnail_max_h }}px; width: auto;" class="img-responsive"></a>';
    ...
    function cleanFloat(number) {
        ...
        if ("{{$jozourSettings->digit_separator}}" == "1.234,56") {
    ...
    function numberWithCommas(value) {
        ...
        if ((value) && ("{{$jozourSettings->digit_separator}}" == "1.234,56")){
    ...
    $(function () {
        $('#bulkEdit').click(function () {
            var selectedIds = $('.jozour-table').bootstrapTable('getSelections');
