<div class="form-group {{ $errors->has($logoVariable) ? 'has-error' : '' }}">
    <div class="col-md-3">
        ...
        @if (($setting->$logoVariable!='') && (Storage::disk('public')->exists(e($jozourSettings->$logoVariable))))
        <div class="col-md-9">
            ...
            <label for="{{ $logoClearVariable }}" style="font-weight: normal">
                ...
                @if ($logoVariable!='favicon')
                    <a href="{{ Storage::disk('public')->url(e($jozourSettings->$logoVariable)) }}" data-toggle="lightbox">
                        <img style="max-height: 60px; padding-top: 10px; padding-bottom: 10px; " alt="" src="{{ Storage::disk('public')->url(e($jozourSettings->$logoVariable)) }}">
                    </a>
                @else
                    <img style="max-height: 50px; padding-top: 10px; padding-bottom: 10px; " alt="" src="{{ Storage::disk('public')->url(e($jozourSettings->$logoVariable)) }}">
                @endif
