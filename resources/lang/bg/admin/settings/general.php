...
return [
    ...
    'ldap_activated_flag_help'  => 'Този флаг се изпозлва за определяне дали потребителя може да се логне в Jozour-IT и не оказва влияние за завеждането на артикули към потребителя.',
    ...
    'load_remote_help_text'		=> 'Тази Jozour-IT инсталация може да зарежда и изпълнява външни скриптове.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ако уеб адреса е вписън тук, потребителите ще бъдат препратени към този URL след като излязат от Jozour-IT. Това е препоръчително за да се затвори сесията от доставчика на удостоверения правилно.',
    ...
    'jozour_version'  			=> 'Jozour-IT версия',
    'support_footer'            => 'Връзки към Jozour-it поддръжката във футъра',
    'support_footer_help'       => 'Указва визуализацията на връзки към поддръжката на Jozour-IT и потребителската документация',
    'version_footer'            => 'Версия в долен колонтитул ',
    'version_footer_help'       => 'Определя кой ще вижда Jozour-IT версията и номера на компилация.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Връзка към Jozour-IT в имейли',
    'show_url_in_emails_help_text'      => 'Премахнете отметката от тази кутийка, ако не желаете да свържете обратно към вашата Jozour-IT инсталация в досиетата ви за електронна поща. Полезно, ако повечето от вашите потребители никога не влизат в системата.',
    'text_pt'        => 'pt',
