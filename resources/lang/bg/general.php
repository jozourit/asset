...
return [
    ...
    'importing_help'        => 'Може да импортирате активи, аксесоари, лицензи, компоненти, консумативи и потребители чрез CSV файл. <br><br>CSV файла трябва да е разделен със запетая и форматирани колони, като тези от <a href="https://jozour-it.readme.io/docs/importing" target="_new">примерен CSV файл</a>.',
    ...
    'slack_test_msg'        => 'Вашата Slack интеграция с Jozour-IT работи!',
