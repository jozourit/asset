...
',
    ...
    'width_w'        => 'عرض',
    'height_h'        => 'ارتفاع',
    'show_url_in_emails'                => 'پیوند به Jozour-IT در ایمیل',
    'show_url_in_emails_help_text'      => 'اگر نمیخواهید پیوند به نصب Jozour-IT خود را در زیرپوشهای ایمیل خود پیگیری کنید، این کادر را بردارید. مفید است اگر اکثر کاربران شما هرگز وارد نشده باشند.',
    'text_pt'        => 'بالای صفحه',
