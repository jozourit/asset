...
return [
    ...
    'load_remote_help_text'		=> 'Tato instalace Jozour-IT může nahrávat skripty z vnějšího světa.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Pokud je zde uvedena adresa URL, uživatelé budou po odhlášení ze Jozour-IT přesměrování na tuto URL. To je užitečné pro správné ukončení relací Authentication providera.',
    ...
    'show_images_in_email_help'   => 'Zrušte zaškrtnutí této kolonky, pokud je instalace Jozour-IT za VPN nebo uzavřenou sítí a uživatelé mimo síť nebudou moci do svých e-mailů načíst obrázky z této instalace.',
    ...
    'jozour_version'  			=> 'Verze Jozour-IT',
    'support_footer'            => 'Odkazy v zápatí na podporu ',
    'support_footer_help'       => 'Určete, kdo uvidí odkazy na Jozour-IT podporu a uživatelskou příručku',
    'version_footer'            => 'Verze v zápatí ',
    'version_footer_help'       => 'Určete kdo uvidí verzi Jozour-IT a číslo sestavení.',
    ...
    'width_w'        => 'š',
    'height_h'        => 'v',
    'show_url_in_emails'                => 'Odkaz na Jozour-IT v e-mailech',
    'show_url_in_emails_help_text'      => 'Zrušte zaškrtnutí tohoto políčka, pokud nechcete odkazovat zpět na instalaci Jozour-IT do vašich emailových patek. Užitečné, pokud se většina vašich uživatelů nikdy nepřihlásí.',
    'text_pt'        => 'pt',
