...
return [
    ...
    'audit_interval_help'       => 'Varlıklarınızı düzenli olarak fiziksel bir şekilde denetlemeniz gerekiyorsa, kullandığınız aralığı ay olarak girin. Bu değeri güncellerseniz, yaklaşan bir denetim tarihi olan tüm varlıklar için "sonraki denetim tarihleri" güncellenecektir.',
    ...
    'ldap_activated_flag_help'  => 'Bu bayrak, bir kullanıcının Jozour-IT\'de oturum açıp açamayacağını belirlemek için kullanılır ve öğelerin içeri veya dışarı teslim edilmesini etkilemez.',
    ...
    'load_remote_help_text'		=> 'Bu Jozour-IT kurulumu dış ortamdan scriptler yükleyebilir.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Burada bir URL verilirse, kullanıcı Jozour-IT oturumunu kapattıktan sonra kullanıcılar bu URL\'ye yönlendirilir. Bu, Kimlik Doğrulama sağlayıcınızın kullanıcı oturumlarını doğru bir şekilde kapatmak için kullanışlıdır.',
    ...
    'show_images_in_email_help'   => 'Jozour-IT kurulumunuz bir VPN\'in ya da kapalı bir ağın arkasındaysa ve ağ dışındaki kullanıcılar bu kurulumda sunulan görüntüleri e-postalarına yükleyemezse bu kutunun işaretini kaldırın.',
    'site_name'                 => 'Site Adı',
    'slack'                     => 'Gevşek',
    ...
    'jozour_version'  			=> 'Jozour-IT version',
    'support_footer'            => 'Destek Bağlantıları Altbilgisi ',
    'support_footer_help'       => 'Jozour-IT destek, bilgi ve Kullanıcı Kılavuzu linklerini kimin göreceğini seçin',
    'version_footer'            => 'Altbilgi içinde Sürüm ',
    'version_footer_help'       => 'Jozour-IT sürümünü kimin göreceğini ve yapı numarasını belirleyin.',
    ...
    'width_w'        => 'g',
    'height_h'        => 'y',
    'show_url_in_emails'                => 'E-postalardaki Jozour-IT\'ye bağlantı',
    'show_url_in_emails_help_text'      => 'E-posta altbilgilerinizdeki Jozour-IT kurulumuna geri dönmek istemiyorsanız, bu kutuyu kaldırın. Kullanıcılarınızın çoğu hiç giriş yapmazsa kullanışlıdır.',
    'text_pt'        => 'dpi',
    ...
    'barcodes_help' => 'Bu, önbelleğe alınmış barkodları silmeyi dener. Bu, genellikle yalnızca barkod ayarlarınız değiştiyse veya Jozour-IT URL\'niz değiştiyse kullanılır. Bir sonraki erişimde barkodlar yeniden oluşturulacaktır.',
