...
return [
    ...
    'ldap_activated_flag_help'  => 'Esta casilla se utiliza para determinar cuando un usuario puede, o no, iniciar sesion en Jozour-IT, sin embargo no afecta la habilidad de entregar/recibir ítems del mismo.',
    ...
    'load_remote_help_text'		=> 'Esta instalación de Jozour-IT puede cargar scripts desde el mundo exterior.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si se proporciona una url aquí, los usuarios serán redirigidos a esta URL después de que el usuario cierre la sesión de Jozour-IT. Esto es útil para cerrar correctamente las sesiones de usuario de su proveedor de autenticación.',
    ...
    'show_images_in_email_help'   => 'Desmarca esta casilla si tu instalación de Jozour-IT está detrás de una red privada o VPN y los usuarios fuera de la red no pueden cargar las imágenes servidas desde este servidor en sus correos electrónicos.',
    ...
    'jozour_version'  			=> 'Version de Jozour-IT',
    'support_footer'            => 'Enlaces de Soporte de Pie de Página ',
    'support_footer_help'       => 'Especifica quién ve los links a la información de Soporte Jozour-IT y el Manual de Usuario',
    'version_footer'            => 'Versión en pie de página ',
    'version_footer_help'       => 'Especifica quién ve la versión y el número de compilación de Jozour-IT.',
    ...
    'width_w'        => 'an',
    'height_h'        => 'al',
    'show_url_in_emails'                => 'Enlace a Jozour-IT en correos electrónicos',
    'show_url_in_emails_help_text'      => 'Desmarca esta casilla si no deseas volver a enlazar a tu instalación Jozour-IT en los pie de página de tu correo electrónico. Útil si la mayoría de tus usuarios nunca inicia sesión. ',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Esto intentará eliminar códigos de barras en caché. Esto normalmente sólo se usaría si la configuración del código de barras ha cambiado, o si la URL de Jozour-IT ha cambiado. Los códigos de barras se regenerarán cuando se acceda a continuación.',
