...
return [
    ...
    'load_remote_help_text'		=> 'זה Jozour-IT להתקין יכול לטעון סקריפטים מהעולם החיצון.',
    ...
    'jozour_version'  			=> 'Jozour-IT גירסה',
    ...
    'show_url_in_emails_help_text'      => 'בטל את הסימון בתיבה זו אם אינך רוצה לקשר חזרה את ההתקנה Jozour-IT שלך תחתונות הדוא"ל. שימושי אם רוב המשתמשים שלך לא מתחברים.',
    'text_pt'        => 'pt',
