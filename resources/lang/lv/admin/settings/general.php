...
return [
    ...
    'load_remote_help_text'		=> 'Šī Jozour-IT instalēšana var ielādēt skriptus no ārpasaules.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ja šeit ir norādīts URL, lietotāji tiks novirzīti uz šo URL pēc tam, kad lietotājs izrakstīsies no Jozour-IT. Tas ir noderīgi, lai pareizi aizvērtu lietotāja sesijas no jūsu lietotāju autentifikāciju nodrošinātāja.',
    ...
    'show_images_in_email_help'   => 'Noņemiet atzīmi no šīs izvēles rūtiņas, ja jūsu Jozour-IT instalācija atrodas aiz VPN vai slēgta tīkla un lietotāji ārpus tīkla savā e-pasta ziņojumā nevarēs ielādēt attēlus, kas tiek rādīti no šīs instalācijas.',
    ...
    'jozour_version'  			=> 'Jozour-IT versija',
    'support_footer'            => 'Atbalsta kājenes saites ',
    'support_footer_help'       => 'Norādiet, kurš redz saites uz Jozour-IT atbalsta informāciju un lietotāju rokasgrāmatu.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Saite uz Jozour-IT e-pasta ziņojumos',
    'show_url_in_emails_help_text'      => 'Noņemiet atzīmi no šīs izvēles rūtiņas, ja nevēlaties savā e-pasta kājenēs atvērt saiti uz savu Jozour-IT instalāciju. Noderīgi, ja lielākā daļa jūsu lietotāju nekad neiesakās.',
    'text_pt'        => 'pt',
