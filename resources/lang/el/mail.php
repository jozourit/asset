...
return [
    ...
    'login_first_admin' => 'Συνδεθείτε στη νέα σας εγκατάσταση Jozour-IT χρησιμοποιώντας τα παρακάτω διαπιστευτήρια:',
    'login' => 'Σύνδεση:',
    ...
    'tag' => 'Ετικέτα',
    'test_email' => 'Έλεγχος email για Jozour-IT',
    'test_mail_text' => 'Πρόκειται για μια δοκιμή από το σύστημα διαχείρισης περιουσιακών στοιχείων της Jozour-IT. Αν το έχετε, το mail λειτουργεί :)',
    ...
    'your_credentials' => 'Τα διαπιστευτήρια σας Jozour-IT',
