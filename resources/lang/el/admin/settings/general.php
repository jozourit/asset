...
return [
    ...
    'load_remote_help_text'		=> 'Αυτή η εγκατάσταση Jozour-IT μπορεί να φορτώσει δέσμες ενεργειών από τον έξω κόσμο.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Εάν παρέχεται ένα url εδώ, οι χρήστες θα ανακατευθυνθούν σε αυτήν τη διεύθυνση URL αφού ο χρήστης αποσυνδεθεί από το Jozour-IT. Σε περίπτωση που χρησιμοποιήτε κάποιο συγκεκριμένο πάρωχο Authentication.',
    ...
    'show_images_in_email_help'   => 'Uncheck this box if your Jozour-IT installation is behind a VPN or closed network and users outside the network will not be able to load images served from this installation in their emails.',
    ...
    'jozour_version'  			=> 'Jozour-It έκδοση',
    'support_footer'            => 'Support Footer Links ',
    'support_footer_help'       => 'Specify who sees the links to the Jozour-IT Support info and Users Manual',
    'version_footer'            => 'Έκδοση στο υποσέλιδο ',
    'version_footer_help'       => 'Καθορίστε ποιός μπορεί να δει την έκδοση και τον αριθμό κατασκευής του Jozour-ΙΤ.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Σύνδεση με το Jozour-IT στα ηλεκτρονικά ταχυδρομεία',
    'show_url_in_emails_help_text'      => 'Καταργήστε την επιλογή αυτού του πλαισίου αν δεν θέλετε να συνδεθείτε πίσω στην εγκατάσταση Jozour-IT στα υποσέλιδα ηλεκτρονικού ταχυδρομείου σας. Χρήσιμο αν οι περισσότεροι χρήστες σας δεν συνδέονται ποτέ.',
    'text_pt'        => 'pt',
