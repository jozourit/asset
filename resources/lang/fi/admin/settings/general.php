...
return [
    ...
    'ldap_activated_flag_help'  => 'Tätä käytetään sen määrittämiseen, voiko käyttäjä kirjautua Jozour-IT: ään. Tällä ei ole vaikutusta luovutus ja palautus toimintoihin.',
    ...
    'load_remote_help_text'		=> 'Tämä Jozour-IT-asennus voi ladata skriptejä ulkopuolelta.',
    ...
    'show_images_in_email_help'   => 'Poista tämä valinta, jos Jozour-IT asennus on toteutettu VPN: n avulla tai suljetussa verkossa, koska sähköposteissa käytetyt kuvat eivät voi latautua näkyviin sähköposteissa.',
    ...
    'jozour_version'  			=> 'Jozour-IT versio',
    'support_footer'            => 'Tuki-alatunnisteen linkit ',
    'support_footer_help'       => 'Määrittele, kuka voi nähdä linkit Jozour-IT tukipalvelun tietoihin ja käyttöohjeeseen',
    'version_footer'            => 'Versio alatunnisteessa ',
    'version_footer_help'       => 'Määrittele, kuka näkee Jozour-IT järjestelmän version ja käännöksen numeron.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'k',
    'show_url_in_emails'                => 'Linkki Jozour-IT: hen sähköposteissa',
    'show_url_in_emails_help_text'      => 'Poista tämä valintaruutu, jos et halua linkata takaisin Jozour-IT-asennukseen sähköpostin alatunnisteisiin. Hyödyllinen, jos useimmat käyttäjät eivät koskaan kirjaudu sisään.',
    'text_pt'        => 'pt',
