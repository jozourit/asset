...
return [
    ...
    'import'         	    => 'Nhập',
    'importing'         	=> 'Importing',
    'importing_help'        => 'Bạn có thể nhập nội dung, phụ kiện, giấy phép, linh kiện, vật tư tiêu hao và người dùng qua tệp CSV. <br> <br> CSV phải được phân cách bằng dấu phẩy và được định dạng với các tiêu đề khớp với các tiêu đề trong <a href="https://jozour-it.readme.io/docs/importing" target="_new"> CSV trong tài liệu mẫu </a>.',
    ...
    'slack_test_msg'        => 'Có vẻ như tích hợp Slack của bạn với Jozour-IT đang hoạt động!',
