...
Linjeskift, topptekst, bilder, osv. kan føre til uventede resultater.',
    ...
    'ldap_activated_flag_help'  => 'Dette merket brukes til å bestemme om en bruker kan logge inn på Jozour-IT eller ikke, og påvirker ikke muligheten til å sjekke inn eller ut enheter til dem.',
    ...
    'load_remote_help_text'		=> 'Denne Jozour-IT-installasjonen kan laste skript fra Internett.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Hvis en URL angis her blir brukerne videresendt til denne URLen etter utlogging fra Jozour-IT. Dette er nyttig for korrekt lukking av autentiseringssesjoner hos din autentiseringsleverandør.',
    ...
    'show_images_in_email_help'   => 'Fjern merkingen i denne boksen hvis Jozour-IT-installasjonen er bak en VPN eller et lukket nettverk og brukere utenfor nettverket ikke vil kunne laste bilder servert fra denne installasjonen i e-posten.',
    ...
    'jozour_version'  			=> 'Jozour-IT-versjon',
    'support_footer'            => 'Støtte Footer Lenker ',
    'support_footer_help'       => 'Angi hvem som kan se lenker til Jozour-IT supportinformasjon og brukermanual',
    'version_footer'            => 'Versjon i Footer ',
    'version_footer_help'       => 'Angi hvem som kan se Jozour-IT versjon og build-nummer.',
    ...
    'width_w'        => 'b',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link til Jozour-IT i e-post',
    'show_url_in_emails_help_text'      => 'Fjern markeringen i denne boksen hvis du ikke vil koble tilbake til Jozour-IT-installasjonen i e-postboksene dine. Nyttig hvis de fleste av brukerne aldri logger inn.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Dette forsøker å slette hurtigbufrede strekkoder. Dette vil vanligvis bare bli brukt hvis strekkodeinnstillingene dine er endret, eller hvis Jozour-IT adressen er endret. Strekkoder genereres på nytt når de blir åpnet neste gang.',
