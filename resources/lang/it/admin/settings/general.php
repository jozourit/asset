...
return [
    ...
    'ldap_activated_flag_help'  => 'Questo flag è usato per determinare se un utente può accedere a Jozour-IT e non influisce sulla capacità di assegnare o revocare oggetti a questi.',
    ...
    'load_remote_help_text'		=> 'Questa installazione di Jozour-IT può caricare script dal mondo esterno.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se qui viene indicato un URL, gli utenti verranno reindirizzato a questo URL dopo essere usciti da Jozour-IT. Questo è utile per chiudere correttamente le sessioni dell\'utente.',
    ...
    'show_images_in_email_help'   => 'Deseleziona questa casella se l\'installazione di Jozour-IT si trova dietro una rete VPN o chiusa e gli utenti esterni alla rete non saranno in grado di caricare le immagini fornite da questa installazione nelle loro e-mail.',
    'site_name'                 => 'Nome sito',
    'slack'                     => 'Slack',
    ...
    'support_footer_help'       => 'Specificare chi vede i collegamenti alle informazioni sul supporto IT e su Jozour-IT',
    'version_footer'            => 'Versione a piè di pagina ',
    'version_footer_help'       => 'Specifica chi può vedere la versione di Jozour-IT e il numero di build.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Collegamento a Jozour-IT in posta elettronica',
    'show_url_in_emails_help_text'      => 'Deseleziona questa casella se non si desidera collegare nuovamente all\'installazione Jozour-IT nei piè di pagina di posta elettronica. Utile se la maggior parte dei tuoi utenti non entra mai in login.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Ciò eliminerà i codici a barre nella cache, utilizzato di solito se le impostazioni dei codici a barre sono cambiate, o se l\'URL di Jozour-IT è cambiato. I codici a barre saranno ri-generati alla prossima richiesta.',
