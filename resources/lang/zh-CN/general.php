...
return [
    ...
    'import'         	    => '导入',
    'importing'         	=> '正在导入…',
    'importing_help'        => '您可以通过CSV文件导入资产、配件、许可证、组件、消耗品和用户。 <br><br>CSV 应以逗号分隔和格式化，并且在文档</a> 中与 <a href="https://jozour-it.readme.io/docs/importing" target="_new">样本CSV中的标头匹配。',
    ...
    'slack_test_msg'        => '哦哈！看起来 Slack 已经成功应用到 Jozour-IT 了！',
