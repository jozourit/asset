...
return [
    ...
    'login_first_admin' => '请使用以下凭据登录新安装的 Jozour-IT：',
    'login' => '登录：',
    ...
    'supplier' => '供应商',
    'tag' => '标签',
    'test_email' => 'Jozour-IT 测试邮件',
    'test_mail_text' => '这是一封 Jozour-IT 资产管理系统的测试电子邮件，如果您收到，表示邮件通知正常运作 :)',
    ...
    'welcome' => '欢迎您，:name',
    'welcome_to' => '欢迎来到 :web！',
    'your_credentials' => '您的 Jozour-IT 登录凭据',
