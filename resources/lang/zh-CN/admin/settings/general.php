...
return [
    ...
    'ldap_activated_flag_help'  => '该标志用于确定用户是否可以登录Jozour-IT，不影响用户对其进行物品查询。',
    ...
    'load_remote_help_text'		=> '允许Jozour-IT安装外部的加载脚本。',
    'login'                     => '登录尝试',
    'login_attempt'             => '登录尝试',
    'login_ip'                  => 'IP 地址',
    'login_success'             => '成功？',
    ...
    'login_remote_user_custom_logout_url_help' => '如果此处提供了URL，则在用户注销Jozour-IT后，用户将被重定向到此URL。这对于正确关闭身份验证提供程序的用户会话非常有用。',
    ...
    'show_images_in_email_help'   => '如果外部用户无法在邮件中通过你安装在VPN或内网的Jozour-IT加载图片，请取消此复选框。',
    'site_name'                 => '站点名称',
    'slack'                     => 'Slack',
    ...
    'support_footer_help'       => '指定谁可以看到指向Jozour-IT支持信息和用户手册的链接',
    'version_footer'            => '页脚版本 ',
    'version_footer_help'       => '指定谁可以看到Jozour-IT版本和内部版本号。',
    'system'                    => '系统信息',
    'update'                    => '更新设置',
    'value'                     => '价值',
    'brand'                     => '品牌',
    ...
    'width_w'        => '宽',
    'height_h'        => '高',
    'show_url_in_emails'                => '链接到Jozour-IT在电子邮件',
    'show_url_in_emails_help_text'      => '如果您不希望链接回电子邮件页脚中的Jozour-IT安装，请取消选中此框。如果您的大多数用户从未登录，则很有用',
    'text_pt'        => '磅',
    ...
    'barcodes_help' => '这将尝试删除缓存条形码。 这通常只有在您的条码设置已经更改或您的Jozour-IT 链接已经更改时才使用。 下次访问时将重新生成条码。',
