...
return [
    ...
    'ldap_activated_flag_help'  => 'Ez a jelző annak meghatározására szolgál, hogy egy felhasználó be tud-e jelentkezni a Jozour-IT-be, és nem befolyásolja az elemek be- vagy kipipálásának lehetőségét.',
    ...
    'load_remote_help_text'		=> 'Ez a Jozour-IT telepítés betölti a szkripteket a külvilágtól.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ha megad itt egy URL-t, a felhasználók a Jozour-IT-ből való kilépéskor át lesznek irányítva a megadott URL-re. Ez hasznos lehet a hitelesítés szolgáltatónál meglévő felhasználói munkamenet megfelelő lezárására.',
    ...
    'show_images_in_email_help'   => 'Vegye ki a jelölést innen, ha az Ön Jozour-IT alkalmazása VPN mögött, vagy zárt hálózaton található, és a felhasználók a hálózaton kívül nem tudják az emailekben megjeleníteni az alkalmazás által szolgáltatott képeket.',
    ...
    'jozour_version'  			=> 'Jozour-IT változat',
    'support_footer'            => 'Lábjegyzet linkek támogatása ',
    'support_footer_help'       => 'Adja meg, hogy ki láthassa a Jozour-IT támogatási információ és a felhasználói kézikönyv linkjeit',
    'version_footer'            => 'Verzió a láblécben ',
    'version_footer_help'       => 'Határozza meg, hogy ki láthassa a Jozour-IT verzió és build adatokat.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link a Jozour-IT-re az e-mailekben',
    'show_url_in_emails_help_text'      => 'Törölje a jelet a jelölőnégyzetből, ha nem kíván visszaváltani a Jozour-IT telepítéséhez az e-mail láblécében. Hasznos ha a legtöbb felhasználó soha nem jelentkezik be.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Ez megpróbálja törölni a gyorsítótárazott vonalkódokat. Ezt általában csak akkor használja, ha a vonalkód beállításai megváltoztak, vagy ha a Jozour-IT URL címe megváltozott. A vonalkódok a következő eléréskor újra generálásra kerülnek.',
