...
return [
    ...
    'load_remote_help_text'		=> 'Esta instalação do Jozour-IT pode carregar scripts do mundo exterior.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se preenchido, os utilizadores serão redirecionados para este URL depois de fecharem a sessão no JozourIT. É particularmente útil para fechar corretamente a sessão do utilizador do fornecedor de autenticação.',
    ...
    'show_images_in_email_help'   => 'Desmarque esta caixa se a sua instalação do Jozour-IT estiver a correr através de uma VPN ou rede fechada e utilizadores fora da rede não conseguirem carregar as imagens desta instalação nos seus e-mails.',
    ...
    'jozour_version'  			=> 'Versão Jozour-IT',
    'support_footer'            => 'Links de rodapé de suporte',
    'support_footer_help'       => 'Especifica quem vê os links de Suporte e Manual de utilizador do Jozour-IT',
