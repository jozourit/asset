...
return [
    ...
    'importing_help'        => 'Puede importar activos, accesorios, licencias, componentes, consumibles y usuarios a través de un archivo CSV. <br><br>El CSV debe estar delimitado por comas y con formato de encabezados que coincidan con el archivo <a href="https://jozour-it.readme.io/docs/importing" target="_new">CSV de muestra en la documentación</a>.',
    ...
    'slack_test_msg'        => '¡Oh mira! ¡Parece que tu integración de Slack con Jozour-IT está funcionando!',
