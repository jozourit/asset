...
return [
    ...
    'ldap_activated_flag_help'  => 'Esta bandera se utiliza para determinar si un usuario puede iniciar sesión en Jozour-IT y no afecta a la capacidad de verificar elementos dentro o fuera de ellos.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sí se especifica un URL, los usuarios serán redireccionados a este URL una vez que cierren sesión en Jozour-TI. Esto es útil para cerrar sesiones de usuario de su Authentication Provider de forma correcta.',
    ...
    'version_footer_help'       => 'Especificar quién ve la versión Jozour-IT y el número de compilación.',
