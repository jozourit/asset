...
return [
    ...
    'ldap_activated_flag_help'  => 'Diese Einstellung steuert, ob sich ein Benutzer bei Jozour-IT anmelden kann und hat keinen Einfluss auf die Möglichkeit, Elemente auszugeben oder zurück zu nehmen.',
    ...
    'load_remote_help_text'		=> 'Diese Installation von Jozour-IT kann Skripte von außerhalb laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sofern hier eine URL angegeben ist, werden Benutzer automatisch zu dieser URL weitergeleitet, nachdem der Benutzer sich aus Jozour-IT ausloggt. Dies ist nützlich, um die Benutzersitzung Ihres Authentifizierungsproviders korrekt zu beenden.',
    ...
    'show_images_in_email_help'   => 'Deaktivieren Sie dieses Kontrollkästchen, wenn sich Ihre Jozour-IT-Installation hinter einem VPN oder einem geschlossenen Netzwerk befindet und Benutzer außerhalb des Netzwerks keine Bilder von dieser Installation in ihre E-Mails laden können.',
    ...
    'support_footer_help'       => 'Geben Sie an, wer die Links zum Jozour-IT Support-Info und Benutzerhandbuch sieht',
    'version_footer'            => 'Version in in der Fußzeile ',
    'version_footer_help'       => 'Spezifiert, wer die Version und Build-Nummer von Jozour-IT angezeigt bekommt.',
    ...
    'width_w'        => 'b',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Link zu Jozour-IT in E-Mails',
    'show_url_in_emails_help_text'      => 'Deaktivieren Sie dieses Kontrollkästchen, wenn Sie in Ihren E-Mail-Fußzeilen keine Verbindung zu Ihrer Jozour-IT-Installation herstellen möchten. Nützlich, wenn die meisten Ihrer Benutzer sich nie einloggen.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Dies wird versuchen, zwischengespeicherte Barcodes zu löschen. Dies wird in der Regel nur verwendet werden, wenn sich die Barcode-Einstellungen geändert haben oder sich Ihre Jozour-IT-URL geändert hat. Barcodes werden beim nächsten Zugriff neu generiert.',
