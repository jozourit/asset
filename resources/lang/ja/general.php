...
return [
    ...
    'importing_help'        => 'アセット、アクセサリ、ライセンス、コンポーネント、消耗品、およびユーザーをCSVファイルからインポートできます。 <br><br>CSVは、ドキュメント <a href="https://jozour-it.readme.io/docs/importing" target="_new"></a> のサンプルCSVに一致するヘッダーでカンマ区切りでフォーマットする必要があります。',
    ...
    'slack_test_msg'        => 'こんにちは！SlackとJozour-ITの連携がうまくいっているようです！',
