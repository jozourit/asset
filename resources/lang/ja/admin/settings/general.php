...
<strong>:app_name データベース全体とアップロードされたファイルは、バックアップファイルの内容と完全に置き換わります。 </strong>  ',
    ...
    'ldap_activated_flag_help'  => 'このフラグは、ユーザが Jozour-IT にログインできるかどうかを判断するために使用され、項目をチェックする機能には影響しません。',
    ...
    'load_remote_help_text'		=> 'Jozour-ITのインストールは、外部からスクリプトを読み込むことが可能です。',
    'login'                     => 'ログイン試行',
...
これは認証プロバイダのセッションを正しく終了させる場合に便利です。',
    ...
    'show_images_in_email_help'   => 'Jozour-ITが閉鎖されたネットワーク内にある場合や、アクセスするためにVPNの利用が必要な場合はこのボックスのチェックを外してください。ネットワーク外のユーザは、配信されたメールにある画像を読み込むことはできません。',
    'site_name'                 => 'サイト名',
    'slack'                     => 'Slack',
    ...
    'jozour_version'  			=> 'Jozour-IT バージョン',
    'support_footer'            => 'フッターのリンクをサポートします。 ',
    'support_footer_help'       => 'Jozour-ITサポート情報とユーザーマニュアルへのリンクを確認する',
    'version_footer'            => 'フッターにバージョン情報を表示 ',
    'version_footer_help'       => 'Jozour-ITのバージョンとビルド番号を表示するか、管理者のみに表示させるかを設定できます。',
    'system'                    => 'システム情報',
    'update'                    => '設定を更新',
    'value'                     => '価値',
    'brand'                     => 'ブランディング',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Jozour-ITへのリンク',
    'show_url_in_emails_help_text'      => '電子メールのフッターでJozour-ITのインストールにリンクしたくない場合は、このボックスのチェックを外してください。ほとんどのユーザーが決してログインしない場合に便利です。',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'キャッシュされたバーコードを削除しようとします。 これは通常、バーコード設定が変更された場合や、Jozour-ITのURLが変更された場合にのみ使用されます。 バーコードは次にアクセスしたときに再生成されます。',
