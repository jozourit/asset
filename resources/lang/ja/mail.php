...
return [
    ...
    'login_first_admin' => '以下の新しいログイン情報を使用して、Jozour-ITにログインします。',
    'login' => 'ログイン:',
    ...
    'supplier' => '仕入先',
    'tag' => 'タグ',
    'test_email' => 'Jozour-ITからのテストメール',
    'test_mail_text' => 'これはJozour-IT資産管理システムのテストです。あなたがこれを読めているなら、メール機能は動作しています:)',
    ...
    'your_credentials' => 'Jozour-IT クレデンシャル',
