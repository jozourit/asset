...
return [
    ...
    'load_remote_help_text'		=> 'Ova instalacija Jozour-IT može učitati skripte iz vanjskog svijeta.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ako je ovdje upisan url, korisnici će biti biti preusmjereni na taj URL nakon što se odjave iz Jozour-IT-a. Ovo je korisno radi ispravnog zatvaranja korisničkog session-a kod vašeg pružatelja autentifikacije.',
    ...
    'show_images_in_email_help'   => 'Isključite ovaj okvir ako je vaša Jozour-IT instalacija iza VPN ili zatvorene mreže, a korisnici izvan mreže neće moći učitati slike poslužene s ove instalacije u njihovu e-poštu.',
    ...
    'jozour_version'  			=> 'Jozour-IT verzija',
    'support_footer'            => 'Podrška poveznica u podnožju ',
    'support_footer_help'       => 'Navedite tko vidi poveznice na informacije o Jozour-IT podršci i korisničkom priručniku',
    'version_footer'            => 'Verzija u podnožju ',
    'version_footer_help'       => 'Odredite tko može vidjeti Jozour-IT verziju i build broj.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Veza na Jozour-IT u e-pošti',
    'show_url_in_emails_help_text'      => 'Poništite potvrdni okvir ako ne želite povezati vašu Jozour-IT instalaciju u svoje podnožje e-pošte. Korisno je ako se većina korisnika nikada ne prijavljuje.',
    'text_pt'        => 'PT',
