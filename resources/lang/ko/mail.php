...
return [
    ...
    'login_first_admin' => '아래의 자격 증명을 사용하여 새 Jozour-IT 설치본에 로그인 하세요:',
    'login' => '로그인:',
    ...
    'supplier' => '공급자',
    'tag' => '태그',
    'test_email' => 'Jozour-IT에서 테스트 이메일',
    'test_mail_text' => '이것은 Jozour-IT 자산 관리 시스템에서 온 테스트 입니다. 이 것을 받았다면, 메일은 동작중입니다 :)',
    ...
    'your_credentials' => '당신의 Jozour-IT 인증들',
