...
return [
    ...
    'ldap_activated_flag_help'  => 'Esta bandeira é usada para determinar se um usuário pode fazer login no Jozour-IT e não afeta a capacidade de verificar itens dentro ou fora deles.',
    ...
    'load_remote_help_text'		=> 'Esta instalação do Jozour-IT pode carregar qualquer scripts do mundo.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se uma URL for inserida aqui, os usuários serão redirecionados para a essa URL após desconectarem do Jozour-IT. Isso pode ser útil para encerrar sessões com o seu provedor de Autenticação corretamente.',
    ...
    'show_images_in_email_help'   => 'Desmarque esta caixa se sua instalação de Jozour-IT está por trás de uma VPN ou rede fechada e usuários fora da rede não será capazes de carregar imagens, servidas a partir desta instalação em seus e-mails.',
    ...
    'jozour_version'  			=> 'Versão do Jozour-IT',
    'support_footer'            => 'Links de rodapé de suporte ',
    'support_footer_help'       => 'Especifique quem vê os links para as informações de Suporte Jozour-IT e o Manual do Usuário',
    'version_footer'            => 'Versão no Rodapé ',
    'version_footer_help'       => 'Especifica quem vê o número de versão e compilação do Jozour-lT.',
    ...
    'width_w'        => 'largura',
    'height_h'        => 'altura',
    'show_url_in_emails'                => 'Link para Jozour-IT em E-mails',
    'show_url_in_emails_help_text'      => 'Desmarque esta caixa se não deseja vincular novamente a sua instalação Jozour-IT em seus rodapés de e-mail. Útil se a maioria de seus usuários nunca logar. ',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Isto tentará apagar códigos de barras em cache. Isso normalmente só seria usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do Jozour-IT tivesse sido alterada. Códigos de barras serão re-gerados quando acessados em seguida.',
