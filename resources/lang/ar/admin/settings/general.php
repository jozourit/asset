...
return [
    ...
    'ldap_activated_flag_help'  => 'يستخدم هذا العلم لتحديد ما إذا كان يمكن للمستخدم تسجيل الدخول إلى Jozour-IT ولا يؤثر على القدرة على التحقق من العناصر في أو خارجها.',
    ...
    'login_remote_user_custom_logout_url_help' => 'إذا تم توفير عنوان URL هنا، سيتم إعادة توجيه المستخدمين إلى عنوان URL هذا بعد تسجيل خروج المستخدم من Jozour-IT. هذا مفيد لإغلاق جلسات عمل المستخدم لموفر المصادقة بشكل صحيح.',
    ...
    'show_images_in_email_help'   => 'قم بإلغاء تحديد هذا المربع إذا كان تثبيت Jozour-IT وراء شبكة VPN أو شبكة مغلقة ولن يتمكن المستخدمون خارج الشبكة من تحميل الصور التي يخدمها هذا التثبيت في رسائل البريد الإلكتروني الخاصة بهم.',
    ...
    'jozour_version'  			=> 'قنص-إيت الإصدار',
    ...
    'version_footer_help'       => 'حدد من سوف يرى إصدار Jozour-IT و رقم النسخة.',
    ...
    'width_w'        => 'ث',
    'height_h'        => 'ح',
    'show_url_in_emails'                => 'الرابط إلى Jozour-IT في رسائل البريد الإلكتروني',
    'show_url_in_emails_help_text'      => 'قم بإلغاء اختيار هذا المربع إذا كنت لا ترغب في الربط مرة أخرى إلى Jozour-IT في تذييل البريد الإلكتروني الخاص بك. تعد مفيدة إذا كان معظم المستخدمين لا يقومون بتسجيل الدخول. ',
    'text_pt'        => 'حزب العمال',
