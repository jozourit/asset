...
return [
    ...
    'import'         	    => 'استيراد',
    'importing'         	=> 'الاستيراد',
    'importing_help'        => 'يمكنك استيراد الأصول، الملحقات، التراخيص، المكونات، المواد الاستهلاكية، والمستخدمين عبر ملف CSV. <br><br>يجب أن تكون CSV محددة بفواصل وأن يتم تنسيقها مع رؤوس تطابق تلك الموجودة في <a href="https://jozour-it.readme.io/docs/importing" target="_new">عينة CSVs في الوثائق</a>.',
    ...
    'slack_test_msg'        => 'مرحباً! يبدو أن التكامل مع Slack مع Jozour-IT يعمل!',
