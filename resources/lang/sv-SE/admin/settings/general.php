...
return [
    ...
    'ldap_activated_flag_help'  => 'Denna flagga används för att avgöra om en användare kan logga in på Jozour-IT och påverkar inte möjligheten att checka in eller ut objekt till dem.',
    ...
    'load_remote_help_text'		=> 'Denna Jozour-IT-installation kan ladda skript från omvärlden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Om en URL tillhandahålls här kommer användarna att omdirigeras till den här webbadressen efter att användaren loggat ut från Jozour-IT. Det här är användbart för att stänga användarsessionerna i din autentiseringsleverantör korrekt.',
    ...
    'show_images_in_email_help'   => 'Avmarkera den här rutan om din Jozour-IT-installation ligger bakom ett VPN eller ett stängt nätverk och användare utanför nätverket kan inte ladda bilder som visas från den här installationen i sina e-postmeddelanden.',
    'site_name'                 => 'Sidnamn',
    'slack'                     => 'Slack',
    ...
    'jozour_version'  			=> 'Jozour-IT-versionen',
    'support_footer'            => 'Stöd länkar i sidfot ',
    'support_footer_help'       => 'Ange vem som kan se länkarna till Jozour-IT Support info och användarmanual',
    'version_footer'            => 'Version i sidfot ',
    'version_footer_help'       => 'Specificera vilka som kan se Jozour-IT version och build nummer.',
    ...
    'width_w'        => 'w',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Länk till Jozour-IT i e-post',
    'show_url_in_emails_help_text'      => 'Avmarkera den här rutan om du inte vill länka tillbaka till din Jozour-IT-installation i dina e-postfoton. Användbart om de flesta av dina användare aldrig loggar in.',
    'text_pt'        => 'pt',
    ...
    'barcodes_help' => 'Detta kommer att försöka ta bort cachade streckkoder. Detta skulle normalt bara användas om dina streckkodsinställningar har ändrats, eller om din Jozour-IT-URL har ändrats. Streckkoder kommer att återskapas när de nås härnäst.',
