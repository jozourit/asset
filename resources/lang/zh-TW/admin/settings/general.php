...
',
    ...
    'load_remote_help_text'		=> '允許 Jozour-IT 安裝外部腳本',
    ...
    'login_remote_user_custom_logout_url_help' => '如果此處提供了 URL，則在用戶登出 Jozour-IT 後，用戶將被重定向到此 URL。這對於正確關閉身份驗證提供程序非常有用。',
    ...
    'show_images_in_email_help'   => '如果您的Jozour-IT安裝位於VPN或封閉網絡後面，並且外部網絡的用戶無法將通過此安裝提供的圖像加載到其電子郵件中，請取消選中此框。',
    'site_name'                 => '站台名稱',
    'slack'                     => 'Slack',
    ...
    'jozour_version'  			=> 'Jozour-IT 版本',
    'support_footer'            => '支援頁尾連結',
    'support_footer_help'       => '指定誰可以看到指向Jozour-IT支持信息和用戶手冊的鏈接',
    'version_footer'            => '頁尾版本 ',
    'version_footer_help'       => '指定誰可以看到Jozour-IT版本和內部版本號。',
    'system'                    => '系統資訊',
    'update'                    => '更新設定',
    'value'                     => '價值',
    'brand'                     => '企業識別',
    ...
    'width_w'        => '寬',
    'height_h'        => '高',
    'show_url_in_emails'                => '鏈接到Jozour-IT在電子郵件',
    'show_url_in_emails_help_text'      => '如果您不希望鏈接回電子郵件頁腳中的Jozour-IT安裝，請取消選中此框。如果您的大多數用戶從未登錄，則很有用',
    'text_pt'        => '磅',
