...
return [
    ...
    'ldap_activated_flag_help'  => 'Ce drapeau est utilisé pour déterminer si un utilisateur peut se connecter à Jozour-IT et n\'affecte pas la possibilité d\'associer ou dissocier des éléments.',
    ...
    'load_remote_help_text'		=> 'Cette installation Jozour-IT peut charger des scripts depuis le monde extérieur.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si une URL est spécifiée ici, les utilisateurs seront redirigés vers cette URL après la déconnexion de Jozour-IT. Ceci est utile pour fermer correctement les sessions utilisateur de votre fournisseur d\'authentification.',
    ...
    'show_images_in_email_help'   => 'Décocher cette case si votre installation de Jozour-IT est derrière un VPN ou un réseau fermé et que les utilisateurs en dehors du réseau ne peuvent pas charger les images servies depuis cette installation dans leurs courriels.',
    ...
    'support_footer_help'       => 'Spécifiez qui voit les liens vers les manuels de support utilisateur Jozour-IT',
    'version_footer'            => 'Version en pied de page ',
    'version_footer_help'       => 'Spécifiez qui peut voir la version de Jozour-IT.',
    ...
    'width_w'        => 'l',
    'height_h'        => 'h',
    'show_url_in_emails'                => 'Lien vers Jozour-IT dans les e-mails',
    'show_url_in_emails_help_text'      => 'Décochez cette case si vous ne souhaitez pas relier votre installation Jozour-IT à vos pieds de page. Utile si la plupart de vos utilisateurs ne se connectent jamais.',
    'text_pt'        => 'pt',
