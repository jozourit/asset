...
return [
    ...
    'importing_help'        => 'Vous pouvez importer des matériels, accessoires, licences, composants, consommables et utilisateurs via un fichier CSV. <br><br>Le CSV doit être délimité par des virgules et formaté avec des en-têtes qui correspondent à ceux des <a href="https://jozour-it.readme.io/docs/importing" target="_new">exemples de CSV présents dans la documentation</a>.',
    ...
    'slack_test_msg'        => 'Woohoo ! On dirait que votre intégration Slack -> Jozour-IT fonctionne !',
