...
return [
    ...
    'ldap_activated_flag_help'  => 'Этот флажок используется для определение возможности входа для пользователей в Jozour-IT и не затрагивает возможность выдавать\\забирать у них предметы.',
    ...
    'load_remote_help_text'		=> 'Данная установка Jozour-IT может загружать внешние скрипты.',
    'login'                     => 'Попытки входа',
    ...
    'login_remote_user_custom_logout_url_help' => 'Если здесь будет указан URL-адрес, пользователи будут перенаправлены туда после выхода из Jozour-IT. Это полезно для правильного закрытия пользовательской сессии вашего поставщика аутентификации.',
    ...
    'show_images_in_email_help'   => 'Снимите этот флажок, если ваша установка Jozour-IT находится за VPN или в закрытой сети в случае, если в E-mail-ах, которые просматриваются пользователями за пределами указанной сети не отбражаются/не загружаются изображения из данной установки Jozour-IT.',
    ...
    'jozour_version'  			=> 'Версия Jozour-IT',
    'support_footer'            => 'Ссылки на поддержу в нижнем колонтитуле ',
    'support_footer_help'       => 'Отображать или не отображать ссылку на руководство пользователя и поддержку Jozour-IT',
    'version_footer'            => 'Версия в нижнем колонтитуле ',
    'version_footer_help'       => 'Отображать или не отображать версию и номер сборки Jozour-IT.',
    ...
    'width_w'        => 'ширина',
    'height_h'        => 'высота',
    'show_url_in_emails'                => 'Ссылка на Jozour-IT в электронных письмах',
    'show_url_in_emails_help_text'      => 'Снимите этот флажок, если вы не хотите ссылаться на свою установку Jozour-IT в нижних колонтитулах электронной почты. Полезно, если большинство ваших пользователей никогда не заходят в систему.',
    'text_pt'        => 'pt',
