...
return [
    ...
    'importing_help'        => 'Вы можете импортировать активы, аксессуары, лицензии, компоненты, расходные материалы и пользователей через CSV-файл. <br><br>CSV должен быть разделен запятыми и отформатирован заголовками, которые соответствуют заголовкам <a href="https://jozour-it.readme.io/docs/importing" target="_new">образца CSV в документации</a>.',
