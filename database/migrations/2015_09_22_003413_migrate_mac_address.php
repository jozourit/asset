...
class MigrateMacAddress extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('assets', function (Blueprint $table) {
            $table->renameColumn('mac_address', '_jozourit_mac_address');
        });

        // DB::statement("ALTER TABLE assets CHANGE mac_address _jozourit_mac_address varchar(255)");
    ...
    public function down()
    {
        ...
        DB::statement('ALTER TABLE assets CHANGE _jozourit_mac_address mac_address varchar(255)');
    }
}
