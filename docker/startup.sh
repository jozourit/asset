...
if [ -f /var/lib/jozourit/ssl/jozourit-ssl.crt -a -f /var/lib/jozourit/ssl/jozourit-ssl.key ]
then
  a2enmod ssl
else
  a2dismod ssl
...
chown -R docker:root /var/lib/jozourit/data/*
chown -R docker:root /var/lib/jozourit/dumps
chown -R docker:root /var/lib/jozourit/keys
