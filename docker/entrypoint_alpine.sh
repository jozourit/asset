...
#if [ ! -f /var/lib/jozourit/ssl/jozourit-ssl.crt -o ! -f /var/lib/jozourit/ssl/jozourit-ssl.key ]
#then
...
chown -R apache:root /var/lib/jozourit/data/*
chown -R apache:root /var/lib/jozourit/dumps
chown -R apache:root /var/lib/jozourit/keys
