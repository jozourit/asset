...
for dir in \
  ...
  'keys'
do
  [ ! -d "/var/lib/jozourit/$dir" ] && mkdir -p "/var/lib/jozourit/$dir"
done

# Sync /var/lib/jozourit (docker volume) with /var/www/html directory
ln -fs \
  "/var/lib/jozourit/data/private_uploads" "/var/www/html/storage/private_uploads"
ln -fs \
  "/var/lib/jozourit/data/uploads" "/var/www/html/public/uploads"
ln -fs \
  "/var/lib/jozourit/dumps" "/var/www/html/storage/app/backups"
ln -fs \
  "/var/lib/jozourit/keys/oauth-public.key" "/var/www/html/storage/oauth-public.key"
ln -fs \
  "/var/lib/jozourit/keys/oauth-private.key" "/var/www/html/storage/oauth-private.key"
...
chown -R www-data:www-data \
  /var/lib/jozourit/data \
  /var/lib/jozourit/dumps \
  /var/lib/jozourit/keys
