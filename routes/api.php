...
Route::group(['prefix' => 'v1', 'middleware' => ['api', 'throttle:api']], function () {
    ...
    Route::get('/', function () {
        return response()->json(
            [
                'status' => 'error',
                'message' => '404 endpoint not found. This is the base URL for the API and does not return anything itself. Please check the API reference at https://jozour-it.readme.io/reference to find a valid API endpoint.',
                'payload' => null,
            ], 404);
    });
        ...
        */
        ...
        Route::fallback(function () {
            return response()->json(
                [
                    'status' => 'error',
                    'message' => '404 endpoint not found. Please check the API reference at https://jozour-it.readme.io/reference to find a valid API endpoint.',
                    'payload' => null,
                ], 404);
        }); // end fallback routes
