...
/**
 * JozourPermissionsPolicy provides methods for handling the granular permissions used throughout Jozour-IT.
 ...
 * }
 */
abstract class JozourPermissionsPolicy
{
    /**
    ...
    public function before(User $user, $ability, $item)
    {
        ...
        if ($item instanceof \App\Models\JozourModel && ! Company::isCurrentUserHasAccess($item)) {
            return false;
        }
