...
use App\Models\JozourSCIMConfig;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('ArieTimmerman\Laravel\SCIMServer\SCIMConfig', JozourSCIMConfig::class); // this overrides the default SCIM configuration with our own
