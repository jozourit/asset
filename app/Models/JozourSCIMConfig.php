...
class JozourSCIMConfig extends \ArieTimmerman\Laravel\SCIMServer\SCIMConfig
{
    public function getUserConfig()
    {
        ...
        $config['validations'][$core.'emails'] = 'nullable|array';         // emails are not required in Jozour-IT...
        ...
        /* 
          more jozour-it attributes I'd like to check out (to map to 'enterprise' maybe?):
         - website
         - notes?
         - remote???
         - location_id ?
