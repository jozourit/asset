...
class SecurityHeaders
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        // Ugh. Feature-Policy is dumb and clumsy and mostly irrelevant for Jozour-IT,
        ...
        // For example, some IT depts have IFRAMED Jozour-IT into their IT portal
        ...
        // people who are not running Jozour-IT over TLS (shame, shame, shame!)
        // Seriously though, please run Jozour-IT over TLS. Let's Encrypt is free.
