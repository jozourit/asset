...
class UsersController extends Controller
{
    ...
    public function update(SaveUserRequest $request, $id)
    {
         ...
         * 
         *  Thanks, jerks. You are why we can't have nice things. - jozour
         * 
         */ 
        ...
        if ($user->save()) {
            ...
            // This was changed in Jozour-IT v4.6.x to 4.7, since we upgraded to Laravel 5.5
     ...
     *
     * @author [N. Mathar] [<jozour@jozour.net>]
     * @since [v5.0]
     * @param $userId
     * @return string JSON
     */
