...
class RestoreFromBackup extends Command
{
     ...
     * @var string
     */
    protected $signature = 'jozourit:restore 
     ...
     * @var string
     */
    protected $description = 'Restore from a previously created Jozour-IT backup file';
    ...
    public function handle()
    {
        ...
        if (strpos($sqlfiles[0], 'db-dumps') === false) {
            ...
            //older Jozour-IT installs don't have the db-dumps subdirectory component
        }
