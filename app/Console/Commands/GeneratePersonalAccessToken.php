...
class GeneratePersonalAccessToken extends Command
{
     ...
     * @var string
     */
    protected $signature = 'jozourit:make-api-key 
     ...
     * @var string
     */
    protected $description = 'This console command allows you to generate Personal API tokens to be used with the Jozour-IT JSON REST API on behalf of a user.';
