...
class RecryptFromMcrypt extends Command
{
     ...
     * @var string
     */
    protected $signature = 'jozourit:legacy-recrypt 
    ...
    public function handle()
    {
        ...
        $this->error('================================!!!! WARNING !!!!================================');
        $this->error('================================!!!! WARNING !!!!================================');
        $this->comment("This tool will attempt to decrypt your old Jozour-IT (mcrypt, now deprecated) encrypted data and re-encrypt it using OpenSSL. \n\nYou should only continue if you have backed up any and all old APP_KEYs and have backed up your data.");
