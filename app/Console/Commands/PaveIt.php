...
class PaveIt extends Command
{
     ...
     * @var string
     */
    protected $signature = 'jozourit:pave  {--force : Skip the interactive yes/no prompt for confirmation}';
